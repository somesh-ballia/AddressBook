...
namespace AddressBook
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		//Start Sql Connection String and code
			//SqlConnection cnn = new SqlConnection("data source=ntsrv01;initial catalog=7a47;password=7a47;persist security info=True;user id=7a47;workstation id=WINNT24;packet size=4096");
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Family Address Book";
		...
		public void Connection_To_Database(string sname,string dname,string uid,string pass)
		{
			try
			{
				cnn.ConnectionString = "data source="+ sname +";initial catalog="+ dname +";user id="+ uid +";password="+ pass +";persist security info=True";
				cnn.Open();
